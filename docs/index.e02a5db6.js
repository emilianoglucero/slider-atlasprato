...
parcelRequire = function(modules, cache, entry, globalName) {
    ...
    var nodeRequire = typeof require === "function" && undefined;
    ...
    zkY3: [
        function(require1, module1, exports1) {
            ...
            parcelRequire = function(e, r, t, n) {
                var i, o = "function" == typeof parcelRequire && parcelRequire, u = "function" == typeof require1 && require1;
                function f(t, n) {
                    if (!r[t]) {
                        if (!e[t]) {
                ...
                if (t.length) {
                    ...
                    "object" == typeof exports1 && "undefined" != typeof module1 ? module1.exports = l : "function" == typeof define1 && define1.amd ? define1(function() {
                        return l;
                    }) : n && (this[n] = l);
                }
                ...
                iSxC: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.extractVersion = o, exports1.wrapPeerConnectionEvent = i, exports1.disableLog = s, exports1.disableWarnings = a, exports1.log = u, exports1.deprecated = c, exports1.detectBrowser = p, exports1.compactObject = d, exports1.walkStats = l, exports1.filterStats = b;
                        var n = !0, r = !0;
                        function o(e, t, n) {
                            var r = e.match(t);
                ...
                VHa8: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimGetDisplayMedia = e;
                    },
                    {}, 
                ],
                uI5X: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimMediaStream = s, exports1.shimOnTrack = a, exports1.shimGetSendersWithDtmf = c, exports1.shimGetStats = p, exports1.shimSenderReceiverGetStats = d, exports1.shimAddTrackRemoveTrackWithNative = h, exports1.shimAddTrackRemoveTrack = m, exports1.shimPeerConnection = f, exports1.fixNegotiationNeeded = u, Object.defineProperty(exports1, "shimGetUserMedia", {
                            enumerable: !0,
                            get: function() {
                ...
                YHvh: [
                    function(require1, module1, exports1) {
                        ...
                        r.localCName = r.generateIdentifier(), r.splitLines = function(r) {
                            ...
                            return u.length && (u = 0 === u[0].indexOf("b=TIAS:") ? parseInt(u[0].substr(7), 10) : 0 === u[0].indexOf("b=AS:") ? 1e3 * parseInt(u[0].substr(5), 10) * 0.95 - 16e3 : void 0, n.forEach(function(r) {
                                r.maxBitrate = u;
                            })), n;
                ...
                XRic: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimPeerConnection = c, exports1.shimReplaceTrack = p, Object.defineProperty(exports1, "shimGetUserMedia", {
                            enumerable: !0,
                            get: function() {
                ...
                Fzdr: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimOnTrack = a, exports1.shimPeerConnection = c, exports1.shimSenderGetStats = s, exports1.shimReceiverGetStats = p, exports1.shimRemoveStream = u, exports1.shimRTCDataChannel = C, exports1.shimAddTransceiver = f, exports1.shimCreateOffer = d, exports1.shimCreateAnswer = y, Object.defineProperty(exports1, "shimGetUserMedia", {
                            enumerable: !0,
                            get: function() {
                                return t.shimGetUserMedia;
                            }
                ...
                t1lL: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimLocalStreamsAPI = o, exports1.shimRemoteStreamsAPI = i, exports1.shimCallbacksAPI = n, exports1.shimGetUserMedia = s, exports1.shimConstraints = a, exports1.shimRTCIceServerUrls = c, exports1.shimTrackEventTransceiver = d, exports1.shimCreateOfferLegacy = p;
                        var e = t(require1("../utils"));
                        function t(e) {
                            if (e && e.__esModule) return e;
                            var t = {};
                ...
                GOQK: [
                    function(require1, module1, exports1) {
                        ...
                        Object.defineProperty(exports1, "__esModule", {
                            value: !0
                        }), exports1.shimRTCIceCandidate = i, exports1.shimMaxMessageSize = a, exports1.shimSendThrowTypeError = c, exports1.shimConnectionState = s, exports1.removeAllowExtmapMixed = p;
                ...
                sXtV: [
                    function(require1, module1, exports1) {
                        ...
                        exports1.webRTCAdapter = t.default;
                    },
                    {
                        "webrtc-adapter": "tI1X"
                    }, 
                ...
                "I+31": [
                    function(require1, module1, exports1) {
                        ...
                        exports1.Supports = new (function() {
                            function e() {
                                this.isIOS = [
                                    "iPad",
                                    "iPhone",
                    ...
                    function(require1, module1, exports1) {
                        ...
                        exports1.util = new (function() {
                            ...
                            return r.prototype.noop = function() {}, r.prototype.validateId = function(r) {
                                ...
                                for(var t = [], e = r.size, o = Math.ceil(e / exports1.util.chunkedMTU), n = 0, a = 0; a < e;){
                                    var i = Math.min(e, a + exports1.util.chunkedMTU), s = r.slice(a, i), u = {
                ...
                "8WOs": [
                    function(require1, module1, exports1) {
                        ...
                        }(o = exports1.LogLevel || (exports1.LogLevel = {}));
                        var n = function() {
                            function r() {
                ...
                "9ZRY": [
                    function(require1, module1, exports1) {
                        ...
                        }(e = exports1.ConnectionEventType || (exports1.ConnectionEventType = {})), function(e) {
                            e.Data = "data", e.Media = "media";
                        }(r = exports1.ConnectionType || (exports1.ConnectionType = {})), function(e) {
                            e.Open = "open", e.Close = "close", e.Connection = "connection", e.Call = "call", e.Disconnected = "disconnected", e.Error = "error";
                        }(n = exports1.PeerEventType || (exports1.PeerEventType = {})), function(e) {
                        ...
                        }(o = exports1.PeerErrorType || (exports1.PeerErrorType = {})), function(e) {
                            e.Binary = "binary", e.BinaryUTF8 = "binary-utf8", e.JSON = "json";
                        }(t = exports1.SerializationType || (exports1.SerializationType = {})), function(e) {
                            e.Message = "message", e.Disconnected = "disconnected", e.Error = "error", e.Close = "close";
                        }(a = exports1.SocketEventType || (exports1.SocketEventType = {})), function(e) {
                        ...
                        }(i = exports1.ServerMessageType || (exports1.ServerMessageType = {}));
                    },
                    {}, 
                ],
                wJlv: [
                ...
                iTK6: [
                    function(require1, module1, exports1) {
                        ...
                        exports1.peerjs = {
                            Peer: r.Peer,
                            util: e.util
                        }, exports1.default = r.Peer, window.peerjs = exports1.peerjs, window.Peer = r.Peer;
                    },
                    {
                        "./util": "BHXf",
                        "./peer": "Hxpd"
    ...
    y4dT: [
        function(require1, module1, exports1) {
            "use strict";
            var _peerjs = _interopRequireDefault(require1("peerjs"));
            ...
            var Kinectron = function Kinectron(arg1, arg2) {
                ...
                var AZURERAWWIDTH = 320;
                var AZURERAWHEIGHT = 288;
                var colorwidth;
                var colorheight;
                var depthwidth;
                var depthheight;
                ...
                this.makeConnection = function() {
                    ...
                    connection.on("data", (function(dataReceived) {
                        var data = dataReceived.data, event = dataReceived.event; // to check receiveing fps
                        // if (timer === false) {
                        //   timer = true;
                ...
                this._record = function() {
                    if (!doRecord) {
                        ...
                        if (multiFrame) for(var i = 0; i < currentFrames.length; i++)framesToRecord.push(currentFrames[i]);
                        else framesToRecord.push(this.feed);
                         // Create one media recorder for each feed
                        for(var j = 0; j < framesToRecord.length; j++)mediaRecorders.push(this._createMediaRecorder(framesToRecord[j]));
    ...
    "y4dT"
], null); //# sourceMappingURL=/kinectron-client.js.map

//# sourceMappingURL=index.e02a5db6.js.map
