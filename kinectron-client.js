        ...
        })(
          {
                            ...
                            if (
                              ...
                              void 0 !== i.exact && "number" != typeof i.exact
                                ? ((r.mandatory = r.mandatory || {}),
                                  (r.mandatory[n("", t)] = i.exact))
                                : ["min", "max"].forEach(function (e) {
                                    void 0 !== i[e] &&
                                      ((r.mandatory = r.mandatory || {}),
                                      (r.mandatory[n(e, t)] = i[e]));
                                  });
                            }
                          }),
                          e.advanced &&
            ...
            uI5X: [
              function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                  (exports.shimMediaStream = s),
                  (exports.shimOnTrack = a),
                  (exports.shimGetSendersWithDtmf = c),
                  (exports.shimGetStats = p),
                  (exports.shimSenderReceiverGetStats = d),
                  (exports.shimAddTrackRemoveTrackWithNative = h),
                  (exports.shimAddTrackRemoveTrack = m),
                  (exports.shimPeerConnection = f),
                  (exports.fixNegotiationNeeded = u),
              ...
              function (require, module, exports) {
                ...
                function r(t, r, n, a, i) {
                  ...
                  if (
                    ...
                    (s += "a=" + c),
                      (s +=
                        "a=ssrc:" + t.sendEncodingParameters[0].ssrc + " " + c),
                ...
                function a(e, t) {
                  var r = {
                    ...
                    a = function (e, t, r, a) {
                      ...
                      return (
                        i && s && i.name.toLowerCase() === s.name.toLowerCase()
                      );
                    };
                  return (
            ...
            XRic: [
              function (require, module, exports) {
                ...
                var e = s(require("../utils")),
                  r = require("./filtericeservers"),
                  t = o(require("rtcpeerconnection-shim")),
                ...
                function c(n) {
                  ...
                  (n.RTCPeerConnection = function (t) {
                    return (
                      t &&
                        t.iceServers &&
                        ((t.iceServers = (0, r.filterIceServers)(
                          t.iceServers,
                          i.version
                        )),
                        e.log("ICE servers after filtering:", t.iceServers)),
                      new s(t)
                    );
                  }),
            ...
            "/GzS": [
              function (require, module, exports) {
                ...
                function r(t) {
                  ...
                  if (
                    ((i.getUserMedia = function (t, o, r) {
                      e.deprecated(
                        "navigator.getUserMedia",
                        "navigator.mediaDevices.getUserMedia"
                      ),
                        i.mediaDevices.getUserMedia(t).then(o, r);
                    }),
                    !(
                      r.version > 55 &&
                      "autoGainControl" in
                      ...
                      ((i.mediaDevices.getUserMedia = function (e) {
                        return (
                          "object" === o(e) &&
                            "object" === o(e.audio) &&
                            ((e = JSON.parse(JSON.stringify(e))),
                            s(e.audio, "autoGainControl", "mozAutoGainControl"),
                            s(
                              e.audio,
                              "noiseSuppression",
                              "mozNoiseSuppression"
                      ...
                      n.prototype.applyConstraints = function (e) {
                        return (
                          "audio" === this.kind &&
                            "object" === o(e) &&
                            ((e = JSON.parse(JSON.stringify(e))),
                            s(e, "autoGainControl", "mozAutoGainControl"),
            ...
            Fzdr: [
              function (require, module, exports) {
                ...
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                  (exports.shimOnTrack = a),
                  (exports.shimPeerConnection = c),
                  (exports.shimSenderGetStats = s),
                  (exports.shimReceiverGetStats = p),
                  (exports.shimRemoveStream = u),
                  (exports.shimRTCDataChannel = C),
                  (exports.shimAddTransceiver = f),
                  (exports.shimCreateOffer = d),
                  (exports.shimCreateAnswer = y),
                  Object.defineProperty(exports, "shimGetUserMedia", {
                    enumerable: !0,
                    get: function () {
                      return t.shimGetUserMedia;
            ...
            t1lL: [
              function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                  (exports.shimLocalStreamsAPI = o),
                  (exports.shimRemoteStreamsAPI = i),
                  (exports.shimCallbacksAPI = n),
                  (exports.shimGetUserMedia = s),
                  (exports.shimConstraints = a),
                  (exports.shimRTCIceServerUrls = c),
                  (exports.shimTrackEventTransceiver = d),
            ...
            GOQK: [
              function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: !0 }),
                  (exports.shimRTCIceCandidate = i),
                  (exports.shimMaxMessageSize = a),
                  (exports.shimSendThrowTypeError = c),
                  (exports.shimConnectionState = s),
                  (exports.removeAllowExtmapMixed = p);
                var e = o(require("sdp")),
                  t = n(require("./utils"));
                function n(e) {
                  if (e && e.__esModule) return e;
                  ...
                  if (
                    ...
                    (n.RTCIceCandidate = function (t) {
                      if (
                        ...
                        var n = new o(t),
                          i = e.default.parseCandidate(t.candidate),
                          a = Object.assign(n, i);
                        return (
                          (a.toJSON = function () {
                            return {
            ...
            KtlG: [
              function (require, module, exports) {
                ...
                var e = m(require("./utils")),
                  ...
                  a = m(require("./safari/safari_shim")),
                  t = m(require("./common_shim"));
                function m(e) {
                  if (e && e.__esModule) return e;
                  var i = {};
                  if (null != e)
                ...
                function h() {
                  ...
                  switch (n.browser) {
                    case "chrome":
                      if (!i || !i.shimPeerConnection || !h.shimChrome)
                        return (
                          o(
                      ...
                      o("adapter.js shimming chrome."),
                        (d.browserShim = i),
                        i.shimGetUserMedia(m),
                        i.shimMediaStream(m),
                        i.shimPeerConnection(m),
                        i.shimOnTrack(m),
                        i.shimAddTrackRemoveTrack(m),
                        i.shimGetSendersWithDtmf(m),
                        i.shimGetStats(m),
                        i.shimSenderReceiverGetStats(m),
                        i.fixNegotiationNeeded(m),
                        t.shimRTCIceCandidate(m),
                        t.shimConnectionState(m),
                        t.shimMaxMessageSize(m),
                        t.shimSendThrowTypeError(m),
                        t.removeAllowExtmapMixed(m);
                      break;
                    case "firefox":
                      if (!s || !s.shimPeerConnection || !h.shimFirefox)
                        return (
                          o(
                      ...
                      o("adapter.js shimming firefox."),
                        (d.browserShim = s),
                        s.shimGetUserMedia(m),
                        s.shimPeerConnection(m),
                        s.shimOnTrack(m),
                        s.shimRemoveStream(m),
                        s.shimSenderGetStats(m),
                        s.shimReceiverGetStats(m),
                        s.shimRTCDataChannel(m),
                        s.shimAddTransceiver(m),
                        s.shimCreateOffer(m),
                        s.shimCreateAnswer(m),
                        t.shimRTCIceCandidate(m),
                        t.shimConnectionState(m),
                        t.shimMaxMessageSize(m),
                        t.shimSendThrowTypeError(m);
                      break;
                    case "edge":
                      if (!r || !r.shimPeerConnection || !h.shimEdge)
                        return (
                          o(
                      ...
                      o("adapter.js shimming edge."),
                        (d.browserShim = r),
                        r.shimGetUserMedia(m),
                        r.shimGetDisplayMedia(m),
                        r.shimPeerConnection(m),
                        r.shimReplaceTrack(m),
                        t.shimMaxMessageSize(m),
                        t.shimSendThrowTypeError(m);
                      break;
                    case "safari":
                      ...
                      o("adapter.js shimming safari."),
                        (d.browserShim = a),
                        a.shimRTCIceServerUrls(m),
                        a.shimCreateOfferLegacy(m),
                        a.shimCallbacksAPI(m),
                        a.shimLocalStreamsAPI(m),
                        a.shimRemoteStreamsAPI(m),
                        a.shimTrackEventTransceiver(m),
                        a.shimGetUserMedia(m),
                        t.shimRTCIceCandidate(m),
                        t.shimMaxMessageSize(m),
                        t.shimSendThrowTypeError(m),
                        t.removeAllowExtmapMixed(m);
              ...
              function (require, module, exports) {
                ...
                Object.create &&
                  ...
                  (i.prototype.emit = function (e, n, r, o, s, i) {
                    ...
                    if (a.fn) {
                      switch (
                        (a.once && this.removeListener(e, a.fn, void 0, !0), l)
                      ) {
                        case 1:
                ...
                var o = require("eventemitter3"),
                  ...
                  c = (function (t) {
                    function n(e, r, s, n, o, i) {
                      ...
                      var c = e ? "wss://" : "ws://";
                      return (
                        (a._wsUrl = c + r + ":" + s + n + "peerjs?key=" + o), a
                      );
                    }
                    return (
                      e(n, t),
                      ...
                      (n.prototype._startWebSocket = function () {
                        ...
                        this._socket ||
                          ...
                          (this._socket.onmessage = function (t) {
                            ...
                            try {
                              (r = JSON.parse(t.data)),
                                i.default.log("Server message received:", r);
                            } catch (s) {
                          ...
                          (this._socket.onclose = function (t) {
                            i.default.log("Socket closed.", t),
                              ...
                              e.emit(a.SocketEventType.Disconnected);
                          }),
                  ...
                  l = (function (n) {
                    function s(e, t, l) {
                      ...
                      return (
                        ...
                        f.options._payload &&
                          (f._peerBrowser = f.options._payload.browser),
                    ...
                    return (
                      ...
                      (i.prototype._initializeServerConnection = function () {
                        ...
                        (this._socket = new c.Socket(
                          ...
                          this.socket.on(
                            u.SocketEventType.Disconnected,
                            function () {
                              e.disconnected ||
                                (e.emitError(
                      ...
                      (i.prototype._cleanup = function () {
                        ...
                        try {
                          for (
                            var o = n(this._connections.keys()), r = o.next();
                            !r.done;
                            r = o.next()
                          ) {
                            var i = r.value;
                  ...
                  case "ready":
                    ...
                    if (data.kinect && whichKinect !== null) {
                      if (whichKinect !== data.kinect) {
                        ...
                        console.warn(
                          "The Kinect server set the Kinect type to ".concat(
                            whichKinect
                          )
                        );
                      }
                    ...
                    if (
                      ...
                      console.log(
                        "The Kinect type is set to ".concat(whichKinect)
                      );
                      ...
                      if (doRecord) {
                        ...
                        if (data.depth) {
                          ...
                          _newImg.onload = function () {
                            ...
                            if (doRecord)
                              this._drawImageToCanvas("depth", _newImg);
                          }.bind(this);
                        }
